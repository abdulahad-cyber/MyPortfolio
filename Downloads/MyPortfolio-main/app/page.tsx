...
export default function Portfolio() {
  ...
  const projects = [
    ...
    {
      title: "Job Applicant System (JobAppSys)",
      description:
    ...
    },
    {
      ...
      githubUrl: "https://github.com/abdulahad-cyber/employee-management-assembly",
    },
    {
      ...
      tech: ["C++", "Networking"],
      category: "Systems Programming",
      githubUrl: "https://github.com/abdulahad-cyber/centralized-messaging",
    },
    {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["HTML", "CSS", "Spring Boot", "Front-end", "Back-end", "RESTful APIs"],
    },
    {
      name: "Databases",
      icon: Database,
